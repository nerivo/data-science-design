...
We met via the \href{http://www.s2ds.org/}{S2DS} programme, where they worked together as project mentors.
...
Part 2 focuses on offering more concrete, practical advice. In Chapter \ref{example} we provide an example of a project proposal that we might use when working with a client to define a project. Chapter \ref{whatif} covers our advice how to navigate different ``what-if'' situations and is currently under active development. Chapter \ref{consulting} is primarily aimed at independent contractors/freelancers and covers how to build up a client base and find work. Chapter \ref{help} lists some useful resources for where you can find help in the wider data science community.

...
Neri Van Otten holds a M.Sc. in Computer Science Engineering from Ghent University where she wrote her thesis on optimising energy usage in electrical vehicles by training online personalised deep neural networks. In her 8 years of professional experience, she has worked at various start-ups, a hedge fund and a wide variety of different companies as an independent data science consultant. She focuses mainly on optimising/scaling systems to utalise data in real-time, researching optimal deep learning solutions and building NLP (Natural Language Processing) applications. At the moment, she leads the data science efforts at [SourceBreaker](https://www.sourcebreaker.com/){target="_blank"}, runs her own deep learning start-up [Spot Intelligence](https://www.spotintelligence.com/){target="_blank"} and mentors (aspiring) data scientists. She is passionate about diversity and education and regularly teaches machine learning.

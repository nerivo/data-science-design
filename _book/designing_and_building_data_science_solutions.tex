...
There are many great tools that can generate beautiful looking documentation from comments added in your code. For python, we can highly recommend \href{https://www.sphinx-doc.org/en/master/}{Sphynx} as it is widely used and gives you loads of great styles to choose from.

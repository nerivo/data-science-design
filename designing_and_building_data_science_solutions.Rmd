...
link-citations: yes
linestretch: 1.5
cover-image: "figures/Designing and bulding data science solutions.jpg"
...
knitr::include_graphics(rep('figures/Designing and bulding data science solutions.jpg', 1))
```
...
# What success looks like: the four levels of project evaluation {#levels}
...
There are many great tools that can generate beautiful looking documentation from comments added in your code. For python, we can highly recommend [Sphynx](https://www.sphinx-doc.org/en/master/){target="_blank"} as it is widely used and gives you loads of great styles to choose from. 
